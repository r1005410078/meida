...
pub fn get_upload_token_provider() -> anyhow::Result<Uri> {
    let domain = "sgpubjz98.hd-bkt.clouddn.com";
    let object_name = "2b10badc-79f3-4913-9789-d4d340f667f8_129.jpg";
...
fn test_get_upload_token_provider() {
    let url = get_upload_token_provider().unwrap();
    println!("{}", url);
}
